...
class FiltersUtils:
    ...
    @staticmethod
    def channel_difference_test(img_path: str, tol: int = TOLERANCE) -> np.ndarray:
        """
    ...
    @staticmethod
    def caption_keywords_test(
        img_path: str, coco: COCO, keywords: list = keywords
    ) -> np.ndarray:
        """
